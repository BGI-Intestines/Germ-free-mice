...
#print(unique(GF_C4@meta.data$mice))
SPF_C4 <- Extract_sub(C4,Ident = "mice" ,sub = "SPF")
#print(unique(SPF_C4@meta.data$mice))
obj.list <- list(GF_10x = GF_10x,SPF_10x = SPF_10x,GF_C4 = GF_C4,SPF_C4 = SPF_C4)
#obj.list <- list(GF_C4 = GF_C4,SPF_C4 = SPF_C4)
#obj.list <- list(GF_10x = GF_10x, SPF_10x = SPF_10x)
